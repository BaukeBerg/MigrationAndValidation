...
test bool testSingleNop() = expectEqual([padString("00000 00000 00", 24)], handleNop(1, 0, 0));

list[str] multipleNop = [padString("00010 00005 00",24), padString("00011 00006 00", 24), padString("00012 00007 00",24)];
